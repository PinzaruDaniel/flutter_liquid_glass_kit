...
public class LiquidGlassKitPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    registrar.register(surfaceFactory, withId: "liquid_glass_kit/glass_surface")
    registrar.register(navBarFactory, withId: "liquid_glass_kit/native_nav_bar")
  }
}
...
class LiquidGlassNavBarView: NSObject, FlutterPlatformView, UITabBarDelegate {
  ...
  init(
    ...
    channel = FlutterMethodChannel(
      name: "liquid_glass_kit/native_nav_bar_\(viewId)",
